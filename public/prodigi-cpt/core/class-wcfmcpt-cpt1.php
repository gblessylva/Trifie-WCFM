...
class WCFM_CPT1 {
  ...
  function cpt1_wcfm_endpoint_title( $title, $endpoint ) {
  	...
  	switch ( $endpoint ) {
  		case 'wcfm-cpt1' :
				$title = __( 'Product Template Dashbard', 'wc-frontend-manager' );
			break;
  ...
  public function wcfm_cpt1_load_views( $end_point ) {
	  ...
	  switch( $end_point ) {
	  	case 'wcfm-cpt1':
        include_once( $WCFMcpt->plugin_path . 'views/product-templates/wcfm-view-cpt1.php' );
      break;
      
      case 'wcfm-cpt1-manage':
        include_once( $WCFMcpt->plugin_path . 'views/product-templates/wcfm-view-cpt1-manage.php' );
      break;
	  }
	}
