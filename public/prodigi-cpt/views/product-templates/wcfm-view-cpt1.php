	...
	<div class="wcfm-collapse-content">
		...
		<div class="wcfm-container wcfm-top-element-container">
			...
			if( $has_new = apply_filters( 'wcfm_add_new_cpt1_sub_menu', true ) ) {
				echo '<a id="add_new_wcfm_ele_dashboard" class="add_new_wcfm_ele_dashboard text_tip " href="/wp-admin/edit.php?post_type=trifie_sku&page=upload_prodigi_products" data-tip="' . __('Import ' . WCFM_CPT_1_LABEL, 'wcfm-cpt'). '"><span class="wcfmfa fa-upload"></span></a>';
		...
		<div class="wcfm-container">
			<div id="wcfm_cpt3_listing_expander" class="wcfm-content">
				<table id="trifie_sku" class="display" cellspacing="0" width="100%">
					<thead>
						<tr>
							<th><?php _e( ' Name', 'wcfm-cpt' );?></th>
