...
// 	$product_template_table = $('#product-templates').DataTable( {
// 		"processing": true,
// 		"serverSide": true,
// 		"responsive": true,
// 		"pageLength": parseInt(10),
...
// 		'ajax': {
// 			"type"   : "POST",
// 			"url"    : LoadTemplateAjax.ajax_url,
// 			"data"   : function( d ) {
// 				d.action     = 'load_product_templates',
// 				// d.controller = 'wcfm-load_product_templates',
...
// 		  $product_template_table.ajax.reload();
// 		});
// 	}
...
// 				if($product_template_table) $product_template_table.ajax.reload();
...
// 	// 	  $product_template_table.column(column).visible( false );
// 	// 	} );
// 	// });
